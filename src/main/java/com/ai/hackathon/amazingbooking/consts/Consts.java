...
public final class Consts {
    ...
    public enum OrderField {
        CLIENT_REF_NB("CLIENT_REF_NB"),
        EXPECTED_INSP_DATE("EXPECTED_INSP_DATE"),
        EXPECTED_SHIP_DATE("EXPECTED_SHIP_DATE"),
        VENDOR_NAME("VENDOR_NAME"),
        SUPPLIER_MGR_NAME("SUPPLIER_MGR_NAME"),
        SUPPLIER_MGR_EMAIL("SUPPLIER_MGR_EMAIL"),
        SUPPLIER_MGR_NUMBER("SUPPLIER_MGR_NUMBER"),
        SUPPLIER_MGR_MOBILE("SUPPLIER_MGR_MOBILE"),
        ...
        PO_NUMBER("PO_NUMBER"),
        ORDER_PROD_SAMPLE("ORDER_PROD_SAMPLE"),
        REF_SAMPLE_COMMENTS("REF_SAMPLE_COMMENTS"),
        COLOR_DES("COLOR_DES"),
        ...
        AQL_CRITICAL("AQL_CRITICAL"),
        AQL_MAJOR("AQL_MAJOR"),
        AQL_MINOR("AQL_MINOR"),
        COLLECT_LT_SAMPLE("COLLECT_LT_SAMPLE"),
        COLLECT_LT_SAMPLE_COMMENTS("COLLECT_LT_SAMPLE_COMMENTS"),
        COLLECT_PROD_SAMPLE("COLLECT_PROD_SAMPLE"),
        COLLECT_PROD_SAMPLE_COMMENTS("COLLECT_PROD_SAMPLE_COMMENTS"),
