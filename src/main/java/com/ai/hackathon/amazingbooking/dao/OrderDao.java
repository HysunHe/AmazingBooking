...
public class OrderDao {
    ...
    private void saveOrderGeneralInfo(Connection conn, OrderBean orderBean)
        ...
        try {
            ...
            pstat.setDate(28, new Date(orderBean.getExpectedInspDate().getTime())); //EXPECTED_INSP_DATE
            pstat.setDate(29, null); //ACTUAL_INSP_DATE
            pstat.setDate(29, new Date(orderBean.getExpectedShipDate().getTime())); //EXPECTED_SHIP_DATE
